...
void apply_selection_policy(t81::vm::DecodeProbe& result) {
...
void populate_sampled_logits(t81::vm::DecodeProbe& result) {
...
t81::vm::DecodeProbe run_native_vm_probe(const std::shared_ptr<t81::weights::ModelFile>& model,
