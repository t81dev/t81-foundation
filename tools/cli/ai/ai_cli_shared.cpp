...
void print_usage(std::string_view prog) {
  std::cout
      ...
      << "Current validated bounded task family:\n"
      << "  answer-fixed, classify-fixed, route-fixed, assess-fixed\n"
      << "  These fixed tasks are the current admitted AI OS-object family.\n"
      << "  `inference run`, `workflow ...`, `benchmark run`, and `policy test`\n"
      << "  are separate surfaces and should not be read as admitted family members.\n\n"
