...
required_files=(
  ...
  "$script_dir/expect_packaged_virtualbox_x86_64_handoff_bundle_failure.sh"
  ...
  "$script_dir/../dev/virtualbox_x86_64_handoff_bundle_negative_smoke_fixture/expected-boot-report.txt"
...
/bin/cp "$script_dir/expect_packaged_virtualbox_x86_64_handoff_bundle_failure.sh" "$bundle_dir/"
...
/bin/cp -R "$script_dir/../dev/virtualbox_x86_64_handoff_bundle_negative_smoke_fixture" "$bundle_dir/bundle-negative-smoke"
...

{
  ...
  print -r -- '- expect_packaged_virtualbox_x86_64_handoff_bundle_failure.sh'
  print -r -- '- recovered-artifacts/'
  print -r -- '- bundle-smoke/'
  print -r -- '- bundle-negative-smoke/'
  ...
  print -r -- 'For a local negative smoke-check, run'
  print -r -- 'expect_packaged_virtualbox_x86_64_handoff_bundle_failure.sh .'
