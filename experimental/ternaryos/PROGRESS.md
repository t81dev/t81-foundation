...
| `shell_startup_snapshot.cpp` | Build-time Axion shell snapshot generator: runs the real Phase 5 shell backend, emits a compact startup-shell artifact, and produces the generated header embedded by the ARM EFI developer-lane stub | — |
