...
kernel/
  kernel_main.hpp/.cpp First Axion kernel-owned runtime entry/bootstrap;
                       ...
                       inventory/supervisor-status/recovery/fault/runtime/audit/device lifecycle metadata
...
# Expected: 1751/1751 assertions, 8/8 tests pass
```
