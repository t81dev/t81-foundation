...
kernel/
  kernel_main.hpp/.cpp First Axion kernel-owned runtime entry/bootstrap;
                       ...
                       inventory/supervisor-status/recovery/fault/runtime lifecycle metadata
...
# Expected: 1722/1722 assertions, 8/8 tests pass
```
