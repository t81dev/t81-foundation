...
kernel/
  kernel_main.hpp/.cpp First Axion kernel-owned runtime entry/bootstrap;
                       ...
                       inventory/supervisor-status/recovery/fault/runtime/audit lifecycle metadata
...
# Expected: 1735/1735 assertions, 8/8 tests pass
```
