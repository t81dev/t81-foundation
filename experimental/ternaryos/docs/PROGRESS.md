...
- The next kernel slice is now internal fault-to-pager handoff semantics above the new kernel-owned process-memory ownership and pager-needed fault state, as tracked in `kernel_execution_plan.md`.
...
| :--- | :---: | :---: |
| `t81_ternaryos_hal_boot_test` | 927 | 1 |
