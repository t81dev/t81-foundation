...
- The next kernel slice is now internal pager-resolution semantics above the new kernel-owned process-memory ownership, pager-needed fault state, and internal handoff queue, as tracked in `kernel_execution_plan.md`.
...
| :--- | :---: | :---: |
| `t81_ternaryos_hal_boot_test` | 956 | 1 |
