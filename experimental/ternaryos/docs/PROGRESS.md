...
- The next kernel slice is now a real kernel-owned pager consumer above the new kernel-owned process-memory ownership, pager-needed fault state, internal handoff queue, and internal resolution state, as tracked in `kernel_execution_plan.md`.
...
| :--- | :---: | :---: |
| `t81_ternaryos_hal_boot_test` | 980 | 1 |
