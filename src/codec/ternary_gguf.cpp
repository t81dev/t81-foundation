...
bool TernaryGGUF::read_ternary_tensor(const std::string& filename, std::vector<float>& output,
                                      GGUFDataType& type) {
...
bool TernaryGGUF::write_ternary_tensor(const std::string& filename, const std::vector<float>& input,
                                       GGUFDataType type) {
