...
printf '==========================================================\n'
printf ' T81 AI Assess-Fixed Task \n'
printf '==========================================================\n'
printf '  ↳ Model: assess-fixed-demo\n'
printf '  ↳ Input: %s\n' "$input_text"
printf '  ↳ Expect: a canonical assessment artifact plus provenance refs.\n'
...
if [[ -z "$result_ref" ]]; then
  echo "error: assess-fixed demo did not produce result_ref" >&2
  exit 1
fi
