...
int main() {
    ...
    std::ofstream model_file("/Users/t81dev/Code/t81-foundation/models/small_test_model.gguf", std::ios::binary);
    ...
    model_file.write(reinterpret_cast<const char*>(tensor_data.data()), tensor_data.size() * sizeof(float));
