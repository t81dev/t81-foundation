...
void basic_integration_example() {
  ...
  std::cout << "Verdict: "
            << (verdict.kind == t81::axion::VerdictKind::Allow ? "✅ Allow" : "❌ Deny") << "\n";
...
void policy_engine_example() {
  ...
  std::cout << "File operation: "
            << (file_verdict.kind == t81::axion::VerdictKind::Allow ? "✅ Allowed" : "❌ Denied")
            << "\n";
  ...
  std::cout << "Network operation: "
            << (net_verdict.kind == t81::axion::VerdictKind::Allow ? "✅ Allowed" : "❌ Denied")
            << "\n";
...
void vm_integration_example() {
  ...
  std::vector<Instruction> program = {
      {"LOAD", "x"}, {"ADD", "42"}, {"AgentInvoke", "model"}, {"STORE", "result"}};
...
void canonfs_integration_example() {
  ...
  std::vector<WriteRequest> requests = {{"config.txt", 1024, "text"},
