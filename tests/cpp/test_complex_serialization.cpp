...
int main() {
    ...
    std::cout << "Original program has " << original_program.complex_pool.size() << " complex numbers" << std::endl;
    ...
    std::cout << "Loaded program has " << loaded_program.complex_pool.size() << " complex numbers" << std::endl;
    ...
    for (size_t i = 0; i < original_program.complex_pool.size(); ++i) {
        ...
        std::cout << "Complex " << i << ": (" << orig.re.to_double() 
                  << ", " << orig.im.to_double() << "i) ✓" << std::endl;
    }
