...
void test_deterministic_float_boundaries() {
    ...
    // Test basic deterministic operations (should work)
    {
        ...
        [[maybe_unused]] TFloat sum = a + b;
        [[maybe_unused]] TFloat prod = a * b;
    ...
    // Test deterministic division
    {
        ...
        [[maybe_unused]] TFloat result = a / b;
    ...
    {
        [[maybe_unused]] TFloat x = TFloat::from_double(0.5);
        ...
        [[maybe_unused]] TFloat base = TFloat::from_double(2.0);
        [[maybe_unused]] TFloat exp = TFloat::from_double(3.0);
    ...
    {
        [[maybe_unused]] TFloat inf = TFloat::inf();
        [[maybe_unused]] TFloat nae = TFloat::nae();
        [[maybe_unused]] TFloat zero = TFloat::zero();
