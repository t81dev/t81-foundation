...
| RFC-0041 | SIMD Formalization | proposed | Core AVX2/NEON packed-trit implementation already exists; stable `include/t81/simd/simd.hpp` facade, migration guide, and ARM64 evidence record are in place; remaining work is x86_64 evidence refresh plus compatibility/deprecation closure |
