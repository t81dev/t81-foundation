...
| [A-0023-02] | `State::printed_output` accumulates rendered strings; VM does not require host stdout | `include/t81/vm/state.hpp`; `core/vm/vm.cpp` `Opcode::Print` handler |
