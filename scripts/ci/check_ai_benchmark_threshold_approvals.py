...
KEYRING_SCHEMA_VERSION = "t81.ai.benchmark-threshold-approval-keyring.v1"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--signing-keyring",
        default="",
        help="Path to benchmark threshold approval keyring (defaults to scripts/ci/ai_benchmark_threshold_approval_keyring.json).",
    )
...
def main() -> int:
    ...
    default_keyring = Path(__file__).resolve().with_name("ai_benchmark_threshold_approval_keyring.json")
