...
**Authority:** This document is the normative record of Phase 1 AI opcode conformance evidence.
It MUST NOT be modified after promotion without an RFC amendment or a new conformance report
covering the modified claims (RFC-0032 §6.10).
...
## RFC-0027 / RFC-0031 Cross-Reference Notes

The output hashes recorded above (`d878d6629816575f`, `14d41b8df3810394`, `8715026970757876`) are
the canonical baseline values for the Phase 1 opcode surface.  Per RFC-0031
§Deterministic AI Arithmetic Contract and RFC-0027 §Spec-as-Executable Conformance Model,
these values MUST be reproduced exactly by the following conformance programs once authored
(Phase 2 gate, RFC-0032 §10):
