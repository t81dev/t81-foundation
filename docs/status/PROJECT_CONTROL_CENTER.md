...
| Axion OS Kernel | Medium | Experimental RFC-00B3 path active; kernel-owned handoff, MMU fault reporting, and first persistent runtime state implemented; next milestone is minimal device arbitration on that state boundary |
