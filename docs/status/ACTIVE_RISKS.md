...
| R-15 | VM dispatch concentration in policy bridge increases maintenance risk | Medium | @t81dev | Continue FW-02 extraction; AxCheck/AxReport, AxRead/AxSet/AxVerify/AxHalt, centralized Axion routing, grouped Axion switch-case consolidation, unified Axion case-label dispatch region, and isolated Axion memory-op sub-dispatch completed 2026-03-05 | Open |
