...
| R-03 | Single-owner concentration — all GO/HOLD decisions gated on @t81dev | Medium | @t81dev | Define deputy-approval policy in governance docs before 2026-04-30 | Open |
| R-04 | T81Graph lang-side serialization gap (BG-09) blocks DCP candidacy | Medium | @t81dev | **COMPLETED - Language runtime invokes serialize_canonical() for T81Graph; stable serialization verified** | **Closed** |
