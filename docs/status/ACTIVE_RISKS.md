...
| R-15 | VM dispatch concentration in policy bridge increases maintenance risk | FW-02 closed: Axion opcode pre-dispatch moved outside the main VM opcode switch (`dispatch_axion_opcode_from_step`), with centralized helper routing retained | 2026-03-05 |
