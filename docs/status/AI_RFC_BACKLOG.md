...
- Partial RFCs: `RFC-0000` (7 core items complete; all open items completed), `RFC-0026` (AI-M1–M6 complete; host-float path replacement remains open)
