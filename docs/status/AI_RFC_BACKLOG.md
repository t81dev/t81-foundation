...
- Partial RFCs: `RFC-0000` (7 core items complete; parity codec, formal proofs, post-quantum hash remain open), `RFC-0026` (phase-1 opcode surface complete; `WLOAD` promotion review and RFC-0030 policy follow-on remain)
