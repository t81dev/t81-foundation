...
| **Axion Kernel** | `spec/axion-kernel.md` | Draft | **Beta** | Beta | Medium | Medium | 2026-03-15 | @t81dev | 2026-06-30 | **Beta candidacy review PASSED 2026-03-15** — P4 (§1.2 Safety & Ethics) and P5 (§1.6 Privileged Instruction) fully satisfied; AX-G01 met; 49/49 axion+ethics+policy tests passing. AX-M5/M6/M7 evidence complete. Deferred: verbatim AX-M6 reason-string form, §1.3 call-graph metrics, §2.5 policy subsystem separation. Review record: `docs/records/audits/AXION_BETA_STABILITY_REVIEW_2026-03.md`. |
