...
| **T81Lang** | `spec/t81lang-spec.md` | Draft | **Beta** | Beta (impl) / Draft (spec) | Medium | Low | 2026-03-05 | @t81dev | 2026-05-15 | BG-06/BG-07/BG-08/BG-09 closed. BigInt literals now transport and materialize without silent truncation; narrowing boundaries are explicit and fail-closed. |
