...
- [第 3 章：T81VM 架构](#第-3-章：t81vm-架构)
  - [3.1 概述](#31-概述)
    - [3.1.1 执行管线](#311-执行管线)
  - [3.2 运行时边界](#32-运行时边界)
  - [3.3 内存模型](#33-内存模型)
    - [3.3.1 形式化状态定义](#331-形式化状态定义)
    - [3.3.2 内存段](#332-内存段)
    - [3.3.3 句柄与间接](#333-句柄与间接)
  - [3.4 指令集 (TISC)](#34-指令集-tisc)
    - [3.4.1 指令周期](#341-指令周期)
    - [3.4.2 操作码类别](#342-操作码类别)
  - [3.5 JIT 编译 (Trace-JIT)](#35-jit-编译-trace-jit)
    - [3.5.1 追踪过程](#351-追踪过程)
    - [3.5.2 行为等效性](#352-行为等效性)
