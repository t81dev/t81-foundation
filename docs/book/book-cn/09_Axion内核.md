...
- [第 9 章：Axion 安全内核](#第-9-章：axion-安全内核)
  - [9.1 形式化定义](#91-形式化定义)
  - [9.2 策略模型](#92-策略模型)
    - [9.2.1 策略语言 (S-表达式)](#921-策略语言-s-表达式)
    - [9.2.2 能力 (Capabilities)](#922-能力-capabilities)
  - [9.3 指令拦截](#93-指令拦截)
    - [9.3.1 拦截器钩子](#931-拦截器钩子)
    - [9.3.2 零成本抽象？](#932-零成本抽象？)
  - [9.4 审计日志 (追踪)](#94-审计日志-追踪)
    - [9.4.1 追踪结构](#941-追踪结构)
  - [9.5 认知提升](#95-认知提升)
