...
| **Epoch Scheduling / Audit Determinism (Axion kernel DPE lane)** | Yes (governed non-DCP, experimental TernaryOS boundary) | `axion-epoch-determinism` | **Hard-Fail** | `userland/experimental/tests/epoch_submission_test.cpp`, `userland/experimental/tests/epoch_audit_test.cpp`; governance direction tracked by RFC-0045 / RFC-0046 |
