...
1. **Implementer / contributor:** you want to work on the C++ stack (or inspect the legacy CWEB VM).
...
1. Skim `AGENTS.md` to understand the roles and expectations.
1. Open an issue or RFC if your change affects the spec or architecture.
